...
import in.business.moneymanager.repository.ProfileRepository;
    ...
    public void sendDailyIncomeExpenseRemainder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    ...
                    + "<a href='" + frontendUrl + "' style='display:inline-block;padding:10px 20px;background-color:#4CAF50;color:white;text-decoration:none;border-radius:5px;'>Add Transactions Now</a>"
    ...
    public void sendDailyExpenseSummary(){
        ...
        for(ProfileEntity profile : profiles){
            ...
            if(!todayExpenses.isEmpty()){
                ...
                table.append("<tr><th style='border:1px solid #ddd;padding:8px;text-align:left;background-color:#f2f2f2'>Name</th>");
                table.append("<th style='border:1px solid #ddd;padding:8px;text-align:left;background-color:#f2f2f2'>Amount</th>");
                table.append("<th style='border:1px solid #ddd;padding:8px;text-align:left;background-color:#f2f2f2'>Category</th>");
                ...
                String body = "Hi " + profile.getFullName() + ",<br><br>"
                        + "Here's your daily expense summary:<br><br>"
                        + table
                        + "<br><br>Best regards,<br>Money Manager Team";
